...
{* begin edit *}
	<h2>Welkom</h2>
<p>Vanaf februari, na de eenwielerconventie, start de langverwachte <strong> Specialisatielessenreeks luchtacrobatie(trapeze en doek). </strong> Alle geînteresseerden, gelieve stan een mailtje te doen( stan@balancirk.be )De lessenreeks zal doorgaan in de vrije basisschool Tuinwijk, Lazarijstraat 120 (kortbij het lyceum en de versuz)waarschijnlijk 's zondagnamiddags.</p>
