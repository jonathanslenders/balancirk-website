...
{* begin edit *}
	<h2>Welkom</h2>
	<p>
	Nu onze eindshow achter de rug is, maken we ons alweer klaar voor de volgende show-avond eind mei begin juni.</p>
Hier brengt ons produktiegroepje het beste van zichzelf. Eveneens nodigen we zoals ieder jaar weer enkele artiesten van serieus kaliber uit.</p>
Meer info volgt..
	</p>
