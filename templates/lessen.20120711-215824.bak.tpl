...
<table style="margin: 3em 0;">
	...
	<tr>
		...
		<td>
			...
			3 modules van 5 lessen: jongleren, evenwicht, acro (concrete data volgen)
		</td>
		<td>
			&nbsp;
		</td>
