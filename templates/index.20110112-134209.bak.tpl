...
{* begin edit *}
	<h2>Welkom</h2>
<p>Vanaf februari start de langverwachte <strong> Specialisatielessenreeks luchtacrobatie(trapeze en doek). </strong> Alle geînteresseerden, gelieve stan@balancirk.be een mailtje te doen. De lessenreeks zal doorgaan in de vrije basisschool Tuinwijk, Lazarijstraat 120 (kortbij het lyceum en de versuz)waarschijnlijk 's zondagnamiddags.</p>
