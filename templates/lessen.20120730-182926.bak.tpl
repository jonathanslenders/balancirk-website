...
<ol>
    <li>1. Tuinwijk, Lazerijstraat 120</li>
    <li>2. Katarina, Jan Palfijnlaan 4</li>
    <li>3. Genk College, zaal 2, Collegelaan 1</li>
...
<table style="margin: 3em 0;">
	...
	<tr>
		<td>
			Vrije basisschool Tuinwijk<br />Lazarijstraat 120<br /> 3500 Hasselt.
		</td>
		<td>
