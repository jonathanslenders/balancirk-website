...
{* begin edit *}
	<h2>Welkom</h2>
	<p>
	Het Circus-jaar is jammergenoeg weer afesloten. Maar we maken al druk plannen voor komend schooljaar.</p>
Het aanbod wordt verder uitgebreid, en in de loop van de maand juni zullen we de nieuwe lessenrooster bekendmaken op de site. Ook willen we het komend schooljaar feestelijk aanvangen met een heuse circus-show (begin september). De produktiegroep heeft nog iets meer tijd nodig om hun act helemaal klaar te stomen voor deze avond. Kijk dus regelmatig op de site voor updates.
