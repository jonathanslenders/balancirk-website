...
?>
		<p class="info">Pagina opgeslagen. <a href="/<?php echo $this->scope["page"];?>">Bekijk resultaat</a></p>  
	<?php 
}
else {
?>
		<form method="post" action="?">
			<input type="hidden" name="edit" value="<?php echo $this->scope["page"];?>" />
			<input type="hidden" name="save" value="true" />
			<textarea cols="100" rows="20" name="source"
				style="width: 100%; font-family: Courier, 'Courier New', monospace "><?php echo Dwoo_Plugin_escape($this, (isset($this->scope["source"]) ? $this->scope["source"] : null), 'html', null);?></textarea>
