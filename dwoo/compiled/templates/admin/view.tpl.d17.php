...
if (!("1277059951" == filemtime('templates/base.tpl'))) { ob_end_clean(); return false; };?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
?>
						...
						<?php 
							...
							<?php if ((isset($this->scope["page"]) ? $this->scope["page"] : null)) {
?>
	<h3><?php echo Dwoo_Plugin_escape($this, (isset($this->scope["page"]) ? $this->scope["page"] : null), 'html', null);?></h3>
	<?php 
}
else {
?>
...
<?php echo Dwoo_Plugin_escape($this, (isset($this->scope["source"]) ? $this->scope["source"] : null), 'html', null);?>
