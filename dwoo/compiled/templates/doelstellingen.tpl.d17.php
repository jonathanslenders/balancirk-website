...
if (!("1276935716" == filemtime('templates/base.tpl'))) { ob_end_clean(); return false; };?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
?>
			...
			#content h4 { margin-top: 2em; font-weight: bold; font-size: 120%; font-variant: small-caps; text-align: center; }
...
?>
					<ul id="nav">
						...
						<li class="selected"><a href="doelstellingen">Doelstellingen</a></li>
...
<p>
	Het volgende PDF-bestand bevat de richtlijnen omtrent de vaardigheden die nodig zijn om aan de gevorderden groep deel te nemen.  
</p>
<ul>
	<li><a href="/downloads/leerdoelen.pdf">Download het PDF bestand</a></li>
</ul>
					</div>
				</div>
			</div>
