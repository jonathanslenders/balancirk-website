...
if (!("1307300162" == filemtime('templates/base.tpl'))) { ob_end_clean(); return false; };?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"> 
...
<meta name="description" content="Balancirk - gedreven door de magie van het circus!" /> 
        ...
        * {
            ...
            #content {
 			...
 			#content p, #content h2, #content ul { margin-left: 40px; }
 			#content p.foto { margin-left: 0px; }
