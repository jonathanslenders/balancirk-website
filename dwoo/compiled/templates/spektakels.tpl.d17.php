...
if (!("1307387454" == filemtime('templates/base.tpl'))) { ob_end_clean(); return false; };?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"> 
...
?>
	...
	<tr>
		<td>
			<img style="width: 200px; padding: 0 20px;"
					src="/_albums/2010-07-08-vuurshow-kapermolen/full/DSC_8585.jpg" />
		</td>
		<td>
			<p>
		...
		<script type="text/javascript">
			$(window).resize(function() {
				...
				if (height < 800)
				{
					...
					//$('#container3').height(height - 35 - 300);
