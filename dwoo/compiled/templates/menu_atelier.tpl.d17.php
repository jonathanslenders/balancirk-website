...
if (!("1282252334" == filemtime('templates/base.tpl'))) { ob_end_clean(); return false; };?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	#vertical-alignment-tool	{ float:left; height:50%; margin-bottom: -340px; }
            ...
            #container0 { 
		clear: both;
                background-image: url('graphics/background4.jpeg');
                background-position: center center; background-repeat: no-repeat;}
	    #container1 {
               width: 812px; height: 680px; margin: auto; }
            #container2 { padding: 32px 0px 0px 0px; }
            ...
            .frame-text {
					height: 355px;
					padding: 10px 50px 0 64px; overflow: auto;}
	...
	<body>
		...
		<div id="container2">
            <ul id="menu">
                    <li class=" first"><a href="/menu_atelier">Circusatelier</a>
                        <ul class="first">
		...
		<li><a href="/visie">Visie</a></li>
                ...
                <div class="footer" style="position: relative; margin: 0 0 0 0; width: 805px; ">
                    ...
                    <p style="margin-left: 90px; ">
                        <a href="/index"><img src="graphics/address.png" style="width: 500px; "/></a>
                    </p>
                <!--
