...
if (!("1284802751" == filemtime('templates/base.tpl'))) { ob_end_clean(); return false; };?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	#vertical-alignment-tool	{ float:left; height:50%; margin-bottom: -340px; }
            ...
            #container0 { 
		clear: both;
                background-image: url('graphics/background6.jpeg');
	...
	<body>
		...
		<div id="container2">
            <ul id="menu">
                    <li class="selected first"><a href="/menu-atelier">Circusatelier</a>
                        <ul class="first">
...
<p> Uit de ingredi&euml;nten van onze lessen kan je al het een en ander afleiden
over onze aanpak bij BalanCirk vzw. We willen bij dit toch niet onbelangrijk
punt graag wat meer uitleg geven.  De lesgevers bij BalanCirk vzw hebben ieder
een opleiding voltooid in het werken met circustechnieken. Je kan er dus vanop
aan dat hetgeen aangeleerd wordt, op een structurele en aan het kind aangepaste
manier overgebracht wordt.  </p>

<p> We willen ons duidelijk profileren als een vrijetijdsatelier waar het
werken met de verschillende circustechnieken geen doel op zich is, maar ten
dienste staat van de sociale-, emotionele-, en psychologische ontwikkeling van
ieder kind.  Circus is geen competitie. Er zijn geen wedstrijden en geen
winnaars of verliezers.  Het samenwerken, oefenen en tonen van hetgeen men kan
is de beloning op zich.  Hierbij is het dan ook zeer belangrijk dat ieder kind
zich goed voelt in de groep en zo de nodige succes-ervaringen kan opdoen.  </p>
			...
			<div class="copyright" style="text-align: right; margin-top: 54px; margin-right: 1em; font-size: 10pt; color: #3e5c2b;">
				Copyright &copy; 2010 Balancirk <span style="margin: 0 .5em;">-</span> Illustratie en grafisch ontwerp: &copy; Inger Swinnen 2010
			</div>
		</div>
		</div>
		</div>
