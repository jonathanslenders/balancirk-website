...
if (!("1292663580" == filemtime('templates/base.tpl'))) { ob_end_clean(); return false; };?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
/* -- loop start output */
?>
			<span><a href="album?album=<?php echo Dwoo_Plugin_escape($this, (isset($this->scope["album"]) ? $this->scope["album"] : null), 'html', null);?>">
					<img src="_albums/<?php echo Dwoo_Plugin_escape($this, (isset($this->scope["album"]) ? $this->scope["album"] : null), 'html', null);?>/thumb/<?php echo Dwoo_Plugin_escape($this, (isset($this->scope["cover"]) ? $this->scope["cover"] : null), 'html', null);?>" alt="<?php echo Dwoo_Plugin_escape($this, (isset($this->scope["title"]) ? $this->scope["title"] : null), 'html', null);?> album" /><br />
